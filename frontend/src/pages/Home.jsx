        ...
        >
          ...
          >
            ...
            <motion.button
              ...
              className="px-6 py-3 glass rounded-full font-semibold border-2 border-purple-400/50 hover:border-purple-400/80 transition-colors flex items-center gap-2"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
              <svg
